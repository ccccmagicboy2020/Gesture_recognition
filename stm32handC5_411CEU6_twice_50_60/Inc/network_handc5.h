...
#ifndef __AI_NETWORK_HANDC5_H__
#define __AI_NETWORK_HANDC5_H__
#pragma once

#include "ai_platform.h"
#include "ai_platform_interface.h"

#define AI_NETWORK_HANDC5_MODEL_NAME          "network_handc5"
...
#define AI_NETWORK_HANDC5_OUT_NUM      (1)
#define AI_NETWORK_HANDC5_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 4, 1, NULL), \
}
#define AI_NETWORK_HANDC5_OUT_SIZE { \
  (1 * 1 * 4), \
}
#define AI_NETWORK_HANDC5_OUT_1_SIZE  (1 * 1 * 4)
#define AI_NETWORK_HANDC5_OUT_1_SIZE_BYTES  ((1 * 1 * 4) * 4)

#define AI_NETWORK_HANDC5_N_NODES (68)

AI_API_DECLARE_BEGIN

/*!
 * @defgroup network_handc5
 ...
 * @ref ai_network_handc5_create. Both the activations memory buffer 
 ...
 * using @ref ai_network_handc5_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_NETWORK_HANDC5_*
 * defines into file @ref network_handc5.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_network_handc5_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /*__AI_NETWORK_HANDC5_H__*/
